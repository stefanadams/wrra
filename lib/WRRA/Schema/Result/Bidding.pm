...
sub _colmodel { qw/id number name description value notify bellringer status auctioneer url timer highbid.bid highbid.bidder.name donor.name donor.url donor.advertisement/ }
