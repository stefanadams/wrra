...
sub _colmodel { qw/id number name runningtime timertime description value notifications cansell bellringer status auctioneer url timer startbid minbid highbid.bid highbid.bidder.name donor.name donor.url donor.advertisement/ }
