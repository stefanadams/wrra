...
sub _colmodel { qw/id number name runningtime timerminutes description value notify cansell bellringer status auctioneer url timer startbid minbid highbid.bid highbid.bidder.name donor.name donor.url donor.advertisement/ }
