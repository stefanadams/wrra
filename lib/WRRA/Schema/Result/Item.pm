...
__PACKAGE__->belongs_to(bellitem => 'WRRA::Schema::Result::Bellitem', 'bellitem_id', {join_type=>'left'}); # An Item belongs_to Stockitem, join to Stockitem via stockitem_id
