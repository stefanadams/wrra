...
SKIP : {
	...
	skip $TODO, 3;
	$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '1');
	$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 0); #
	$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2000); #
};

$ENV{WRRA_DATETIME} = "2013-03-10 10:00:00";
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '1');
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 0); #
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2013); #

$ENV{WRRA_DATETIME} = "2013-03-18 16:59:59";
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '1');
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 1);
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2013);
$ENV{WRRA_DATETIME} = "2013-03-18 17:00:00";
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '0');
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 1);
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2013);
...
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '1');
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 2);
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2013);
...
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '1');
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 3);
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2013);
...
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '1');
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 4);
$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2013);
...
SKIP : {
	...
	$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/closed' => '1');
	$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/night' => 0);
	$t->get_ok('/auction' => $headers)->status_is(200)->json_is('/header/about/year' => 2020);
};
